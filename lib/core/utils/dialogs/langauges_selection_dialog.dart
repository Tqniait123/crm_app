...
void showLanguageSelectionDialog({
  ...
  final List<LanguageOption> supportedLanguages = [
    LanguageOption(code: 'en', title: 'English', subtitle: 'English', flagAsset: AppIcons.en),
    LanguageOption(code: 'ar', title: 'العربية', subtitle: 'العربية', flagAsset: AppIcons.ar),
  ];
                ...
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: isSelected ? Colors.blue : Colors.grey.withOpacity(0.3), width: 1),
                    ),
                    child: Row(
                      children: [
                        // Flag
...
class _CompleteLanguageSelectorState extends State<CompleteLanguageSelector> {
  ...
  void _showDropdown() {
    ...
    _overlayEntry = OverlayEntry(
      builder: (context) => LanguageDropdownOverlay(
