...
import 'package:project_name/core/utils/dialogs/custom_toast.dart';
...
class Toaster {
  ...
  static void showToast(String text, {bool isError = true}) {
    BotToast.showCustomText(
      ...
      toastBuilder: (cancelFunc) => CustomToast(message: text),
    );
  }
  ...
  static void showNotification({
    ...
    BotToast.showNotification(title: title, subtitle: subtitle, leading: leading, backgroundColor: backgroundColor);
  }
}
