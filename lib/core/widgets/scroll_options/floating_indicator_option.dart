...
class FloatingIndicatorOption extends BaseScrollOption {
  const FloatingIndicatorOption({super.key, required super.state, required super.onRefresh, super.height});
  ...
  Widget buildContent(BuildContext context) {
    ...
    return FloatingScrollIndicator(itemCount: parkings.length, parkings: parkings, onRefresh: onRefresh);
  }
}
...
class FloatingScrollIndicator extends StatefulWidget {
  ...
  const FloatingScrollIndicator({super.key, required this.itemCount, required this.parkings, required this.onRefresh});

  @override
  State<FloatingScrollIndicator> createState() => _FloatingScrollIndicatorState();
}

class _FloatingScrollIndicatorState extends State<FloatingScrollIndicator> with TickerProviderStateMixin {
      ...
      children: [
        RefreshIndicator(
          ...
          child: ListView.separated(
            ...
            itemBuilder: (context, index) => ParkingCard(parking: widget.parkings[index]),
          ),
        ),
        Positioned(
          bottom: 20,
