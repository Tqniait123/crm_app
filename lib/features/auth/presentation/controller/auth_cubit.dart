...
import 'package:crm_app/features/auth/data/models/params/login_params.dart';
import 'package:crm_app/features/auth/data/models/params/register_params.dart';
import 'package:crm_app/features/auth/data/models/params/reset_password_params.dart';
import 'package:crm_app/features/auth/data/models/params/verify_params.dart';
...
class AuthCubit extends Cubit<AuthState> {
  ...
  Future<void> forgetPassword(String email) async {
    try {
      ...
      response.fold(
        (message) => emit(ForgetPasswordSentOTP(message: message)),
