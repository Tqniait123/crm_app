...
import 'package:crm_app/core/observers/bloc_observer.dart';
import 'package:crm_app/core/services/di.dart';
import 'package:crm_app/core/static/locales.dart';
import 'package:crm_app/core/translations/codegen_loader.g.dart';
...
Future<void> main() async {
  ...
  // Get the language code from CrmAppPreferences
  // final codeLang = sl<CrmAppPreferences>().getLang();
  runApp(
    EasyLocalization(
